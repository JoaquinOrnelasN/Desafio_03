...
class ProductManager {
    ...
    getProductById = async (id) => {
        ...
        if (idCheck) {
            ...
            console.log(`El id: ${id} es incorrecto`);
        }
    }
    ...
    addProduct = async (title, description, price, thumbnail, code, stock) => {
        ...
        if (fs.existsSync(this.path)) {
            ...
            if (codeCheck) return console.log(`El codigo: ${code} cod nombre ${title} ya existe, utilizar otro.`);
            ...
            console.log('Se ha agregado el siguiente producto: ', products[products.length - 1] );
...
const callMethods = async () => {
    ...
    await allProducts.updateProduct(4, {title: "Cinturón",description:"Color café"});

    await allProducts.deleteProduct(3)
